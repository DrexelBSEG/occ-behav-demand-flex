...
output_peak = table(kpi.peak.E_hvac',kpi.peak.E_all',...
    ...
    'VariableNames',...
    {'Energy Use (HVAC) [kWh]','Energy Use (HVAC and Personal Equipment) [kWh]',...
    'Occ#1 Cool Duration [mins]','Occ#1 Warm Duration [mins]',...
    'Occ#2 Cool Duration [mins]','Occ#2 Warm Duration [mins]',...
    'Occ#3 Cool Duration [mins]','Occ#3 Warm Duration [mins]',...
    'Occ#4 Cool Duration [mins]','Occ#4 Warm Duration [mins]',...
    'Occ#5 Cool Duration [mins]','Occ#5 Warm Duration [mins]',...
    'Occ#6 Cool Duration [mins]','Occ#6 Warm Duration [mins]',...
    'Occ#7 Cool Duration [mins]','Occ#7 Warm Duration [mins]'});
...
% write table to csv
writetable(output_peak,[dataFolder,'_peak.csv']);
writetable(output_peak_occ,[dataFolder,'_peak_occ.csv']);
