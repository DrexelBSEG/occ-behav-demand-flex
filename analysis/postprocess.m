...
period_labels = {'peak','nonpeak','precool','rebound'};
...
output = table(kpi.peak.E_hvac',kpi.peak.E_all',...
    ...
    'FF (HVAC) [kWh]','FF (HVAC and Personal Equipment) [kWh]',...
    'Cost (HVAC) [kWh]','Cost (HVAC and Personal Equipment) [kWh]',...
...
output_peak_occ = array2table([[kpi.peak.pf_occ(:,1),kpi.peak.ph_occ(:,1),kpi.peak.sptup_occ(:,1),kpi.peak.sptdown_occ(:,1),1+zeros(length(kpi.peak.pf_occ(:,1)),1)];...
                        [kpi.peak.pf_occ(:,2),kpi.peak.ph_occ(:,2),kpi.peak.sptup_occ(:,2),kpi.peak.sptdown_occ(:,2),2+zeros(length(kpi.peak.pf_occ(:,2)),1)];...
                        [kpi.peak.pf_occ(:,3),kpi.peak.ph_occ(:,3),kpi.peak.sptup_occ(:,3),kpi.peak.sptdown_occ(:,3),3+zeros(length(kpi.peak.pf_occ(:,3)),1)];...
                        [kpi.peak.pf_occ(:,4),kpi.peak.ph_occ(:,4),kpi.peak.sptup_occ(:,4),kpi.peak.sptdown_occ(:,4),4+zeros(length(kpi.peak.pf_occ(:,4)),1)];...
                        [kpi.peak.pf_occ(:,5),kpi.peak.ph_occ(:,5),kpi.peak.sptup_occ(:,5),kpi.peak.sptdown_occ(:,5),5+zeros(length(kpi.peak.pf_occ(:,5)),1)];...
                        [kpi.peak.pf_occ(:,6),kpi.peak.ph_occ(:,6),kpi.peak.sptup_occ(:,6),kpi.peak.sptdown_occ(:,6),6+zeros(length(kpi.peak.pf_occ(:,6)),1)];...
                        [kpi.peak.pf_occ(:,7),kpi.peak.ph_occ(:,7),kpi.peak.sptup_occ(:,7),kpi.peak.sptdown_occ(:,7),7+zeros(length(kpi.peak.pf_occ(:,7)),1)];...
                        [kpi.peak.pf_occ(:,8),kpi.peak.ph_occ(:,8),kpi.peak.sptup_occ(:,8),kpi.peak.sptdown_occ(:,8),8+zeros(length(kpi.peak.pf_occ(:,8)),1)];...
                        [kpi.peak.pf_occ(:,9),kpi.peak.ph_occ(:,9),kpi.peak.sptup_occ(:,9),kpi.peak.sptdown_occ(:,9),9+zeros(length(kpi.peak.pf_occ(:,9)),1)];...
                        [kpi.peak.pf_occ(:,10),kpi.peak.ph_occ(:,10),kpi.peak.sptup_occ(:,10),kpi.peak.sptdown_occ(:,10),10+zeros(length(kpi.peak.pf_occ(:,10)),1)];...
                        [kpi.peak.pf_occ(:,11),kpi.peak.ph_occ(:,11),kpi.peak.sptup_occ(:,11),kpi.peak.sptdown_occ(:,11),11+zeros(length(kpi.peak.pf_occ(:,11)),1)]],...
