...
if isempty(DayofYear)
    DOY_Table=[7 119 189 238; 37 71 197 183; 37 289 191 177; 2 280 228 240; 9 107 170 203];
...
if isempty(init)
    ...
    enableOBM=settings.enableOBM(1);
...
bcvtbveczones = {zeros(1,size(Office1,2)) 0};
Office = {Office1};
...
%% disable OBM if needed (YC 2023/01/06)
if enableOBM==0
    EPlusScheduleVals(:,:)=0;
end
%%
% PHeatFrac_Z1=EPlusScheduleVals(1);
% PFanFrac_Z1=EPlusScheduleVals(2);
% TCool_Z1=EPlusScheduleVals(3);
% THeat_Z1=EPlusScheduleVals(4);
% WindFrac_Z1=EPlusScheduleVals(5);
% OccFrac_Z1=EPlusScheduleVals(6)*23;
% PHeatFrac_Z2=EPlusScheduleVals(7);
% PFanFrac_Z2=EPlusScheduleVals(8);
% TCool_Z2=EPlusScheduleVals(9);
% THeat_Z2=EPlusScheduleVals(10);
% WindFrac_Z2=EPlusScheduleVals(11);
% OccFrac_Z2=EPlusScheduleVals(12)*2;
% PHeatFrac_Z3=EPlusScheduleVals(13);
% PFanFrac_Z3=EPlusScheduleVals(14);
% TCool_Z3=EPlusScheduleVals(15);
% THeat_Z3=EPlusScheduleVals(16);
% WindFrac_Z3=EPlusScheduleVals(17);
% OccFrac_Z3=EPlusScheduleVals(18)*2;
% PHeatFrac_Z4=EPlusScheduleVals(19);
% PFanFrac_Z4=EPlusScheduleVals(20);
% TCool_Z4=EPlusScheduleVals(21);
% THeat_Z4=EPlusScheduleVals(22);
% WindFrac_Z4=EPlusScheduleVals(23);
% OccFrac_Z4=EPlusScheduleVals(24)*10;
...
if isempty(conn)
    ...
    % behavior labels
    BXLabel={'Pheat','Pfan','Tz_cspt','Tz_hspt','WinFrac','OccFrac'};
    % query command
...
%% Compute final setpoint (YC 10/08/2021)
...
%% normal mode
    ...
    OccMatDoc.OccupantMatrix=[OccupantMatrix{1}];
    insert(conn,CollName,OccMatDoc);
...
%% recovery mode
    ...
    ret=find(conn,CollName,'Query',['{"Time":',num2str(clock),...
        ',"DocType":"SimData"}'],'Projection',BXFields);
